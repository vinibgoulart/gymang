// based on https://github.com/alekbarszczewski/graphql-add-middleware, until fork is updated
...
export function addMiddleware(schema, path, fn) {
  ...
  rootTypes.forEach((type) => {
    middlewaredTypes = addMiddlewareToType(type, fn, {
      parentType,
      parentField,
      middlewaredTypes,
    });
...
const addMiddlewareToType = function (
  type,
  fn,
  { parentType, parentField, middlewaredTypes = {} },
) {
